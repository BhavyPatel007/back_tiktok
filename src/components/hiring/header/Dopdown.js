...
const Menus = () => {
  ...
  const [value,setValue]=React.useState('Talent')
  ...
  return (
    <div>
      ...
      <StyledMenu
        ...
        onClose={handleClose}
      >
        <StyledMenuItem onClick={() => navigateUrl("/dashboard/hire/discover","Talent")}>
          <ListItemIcon>
        ...
        <StyledMenuItem onClick={() => navigateUrl("/dashboard/hire/","Projects")}>
          <ListItemIcon>
